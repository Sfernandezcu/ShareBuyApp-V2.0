package com.arizmendi43.sfernandez.sharebuyapp.login;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_registrar = (Button) findViewById(R.id.button_registro_login);
    ...
    // FUNCION CREADA CON DANI EN LA BIBLIOTECA PARA EL BOTON REGISTRARSE DIA 7/11/2017
